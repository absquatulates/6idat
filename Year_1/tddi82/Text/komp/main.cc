...
// Komplettering: programmet ska avsluta vid fel som inte går att åtgärda 
    //KLAR

// Komplettering: vid utskrift av table följt av frequency så är utskriften felaktigt formatterad
    //KLAR
